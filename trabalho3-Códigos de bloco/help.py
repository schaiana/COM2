    ...
    palavras_codigo = code.codeword_table
    print('Palavras-Código:\n {}'.format(palavras_codigo))
    H = code.parity_check_matrix
    print('Matriz de Verificação de Paridade:\n {}'.format(H))
    #W = code.codeword_weight_distribution
    S = code.coset_leader_table
    print('Tabela das Síndromes:\n {}'.format(S))
